        ...
        <Col>
            ...
            <Container fluid="xl">
              <Row>
                ...
                <Col className="right" md="3">
                  <Button onClick={toggle} className="mappopup">
                    <i
          ...
          >
            <ModalHeader toggle={toggle}>
              {stage && stage.title ? stage.title : propertyCategory.name}
            </ModalHeader>
            <ModalBody>
              <ContainerDimensions>
                {({ width }) => (
            ...
            >
              ...
              <ModalBody>
                ...
                <div className="entry property property-smaller">
                  <p>
                    If you are interested in this property please reference the
                    Property ID and contact us.
                  </p>
